---
title: Demo 4 — Copilot Spaces
layout: default
parent: Demos
grand_parent: Intermediate
nav_order: 4
permalink: /intermediate/demos/demo-4.html
description: "Create and use GitHub Copilot Spaces to collaborate on a Photo Gallery app — security analysis or documentation generation."
---

# 🌌 Demo 4 — GitHub Copilot Spaces
{: .no_toc }

**Agenda section:** Collaborative AI workflows
**Language / Surface:** Platform (GitHub Copilot Spaces)
...
👉 **[Start GitHub Copilot Coding Agent Demo]({{ '/intermediate/demos/demo-5.html' | relative_url }})**
