---
title: Demo 5 — Cloud Agent / Mission Control
layout: default
parent: Demos
grand_parent: Intermediate
nav_order: 5
permalink: /intermediate/demos/demo-5.html
description: "Assign GitHub Copilot Coding Agent to an issue, then review the pull request and session it generates."
---

# ☁️ Demo 5 — GitHub Copilot Coding Agent
{: .no_toc }

**Agenda section:** Cloud agent & Mission Control
**Language / Surface:** Platform (GitHub Copilot Coding Agent)
